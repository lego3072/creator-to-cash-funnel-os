...
DB_PATH = DATA_DIR / "creator_to_cash_funnel_os.db"

DATA_DIR.mkdir(parents=True, exist_ok=True)

APP_NAME = "Creator-to-Cash Funnel OS"
APP_SLUG = "creatorcashapi"
DEFAULT_BASE_URL = "https://creator-to-cash-funnel-os.up.railway.app"
...
FOLLOWUP_FROM_EMAIL = os.getenv("FOLLOWUP_FROM_EMAIL", "Creator-to-Cash Funnel OS <joseph@dataweaveai.com>").strip()
...
STARTER_PRICE_LABEL = os.getenv("STARTER_PRICE_LABEL", "$99/mo").strip()
...
STARTER_MONTHLY_COST_CAP_USD = float(os.getenv("STARTER_MONTHLY_COST_CAP_USD", "19.8"))
